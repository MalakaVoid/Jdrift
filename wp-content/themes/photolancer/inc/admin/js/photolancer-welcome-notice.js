(function ($) {
  ...
  $("#install-activate-button").on("click", function (e) {
    ...
    var activationData = {
      action: "photolancer_install_and_activate_plugins",
      nonce: photolancer_localize.nonce,
    };
    $.post(photolancer_localize.ajax_url, activationData, function (response) {
      ...
      if (match) {
        ...
        try {
          ...
          if (responseObj.success === true) {
            window.location.href = photolancer_localize.redirect_url;
          } else {
            console.log("Error!");
          }
        } catch (error) {
